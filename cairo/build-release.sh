...
cd ..
make -f Makefile.win32 "CFG=release" "LIBPNG_PATH=C:/Develop/code/iwallee/teedow/3rd/cairo/libpng1616" "ZLIB_PATH=C:/Develop/code/iwallee/teedow/3rd/cairo/zlib-1.2.8" "PIXMAN_PATH=C:/Develop/code/iwallee/teedow/3rd/cairo/pixman"
