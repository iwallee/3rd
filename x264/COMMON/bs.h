 ...
 * $Id: bs.h,v 1.1.1.1 2005/03/16 13:27:22 264 Exp $
 *
...
static inline uint32_t bs_read( bs_t *s, int i_count )
{
	...
	static const DECLARE_ALIGNED( uint32_t, i_mask[33], 16 )={0x00,
                                  0x01,      0x03,      0x07,      0x0f,
                                  0x1f,      0x3f,      0x7f,      0xff,
...
static inline void bs_write_ue( bs_t *s, unsigned int val )
{
	...
	static const DECLARE_ALIGNED( int, i_size0_255[256], 16 )=
    {
...
static inline int bs_size_ue( unsigned int val )
{
	...
	static const DECLARE_ALIGNED( int, i_size0_254[255], 16 )=
    {
