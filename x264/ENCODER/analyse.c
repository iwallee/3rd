...
static const  DECLARE_ALIGNED( int, i_qp0_cost_table[52], 16 ) =
  {
   1, 1, 1, 1, 1, 1, 1, 1,  /*  0-7 */
   1, 1, 1, 1,              /*  8-11 */
...
static const   DECLARE_ALIGNED( int, i_mb_b_cost_table[18], 16 )= 
{
    9, 9, 9, 0, 0, 0, 1, 3, 7, 7, 7, 3, 7, 7, 7, 5, 9, 0
};
//static const int i_mb_b16x8_cost_table[16] =
static const   DECLARE_ALIGNED( int, i_mb_b16x8_cost_table[16], 16 )= 
{
    0, 0, 0, 0, 0, 0, 0, 5, 7, 7, 7, 5, 7, 9, 9, 9
};
//static const int i_sub_mb_b_cost_table[13] =
static const   DECLARE_ALIGNED( int, i_sub_mb_b_cost_table[13], 16 )= 
{
    7, 5, 5, 3, 7, 5, 7, 3, 7, 7, 7, 5, 1
};
//static const int i_sub_mb_p_cost_table[4] =
static const   DECLARE_ALIGNED( int, i_sub_mb_p_cost_table[4], 16 )= 
{
    5, 3, 3, 1
};
...
/******************************************************************
函数说明：分析一个I 帧的宏块，决定各个子块的类型
参数：  x264_t *h	编码器的数据结构
  		    x264_mb_analysis_t *res  分析的数据结构指针
  		    int i_cost_inter    帧间的的分析代价
返回值: 无
******************************************************************/
