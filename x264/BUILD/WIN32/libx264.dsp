...
# ADD CPP /nologo /G6 /W3 /GX /O2 /Ob2 /I "./common" /I "./encode" /I "./decode" /I "../../extras" /I "../.." /D "NDEBUG" /D "_LIB" /D "WIN32" /D "_MBCS" /D "__X264__" /D "ARCH_X86" /D "HAVE_MMXEXT" /D "HAVE_STDINT_H" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /Zi /Od /I "./common" /I "./encode" /I "./decode" /I "../../extras" /I "../.." /D "_DEBUG" /D "_LIB" /D "WIN32" /D "_MBCS" /D "__X264__" /D "ARCH_X86" /D "HAVE_STDINT_H" /D "HAVE_MMXEXT" /D "DEBUG_BENCHMARK" /FR /FD /GZ /c
...
"$(IntDir)\$(InputName).obj" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	nasmw -f win32 -DPREFIX -o $(IntDir)\$(InputName).obj $(InputPath)
...
SOURCE=..\..\common\i386\predict.c
# End Source File
# Begin Source File

SOURCE=..\..\common\i386\quant_sse2.asm

!IF  "$(CFG)" == "libx264 - Win32 Release"

# Begin Custom Build
IntDir=.\Release
InputPath=..\..\common\i386\quant_sse2.asm
...
SOURCE=..\..\common\i386\rgb_to_yv12_mmx.asm

!IF  "$(CFG)" == "libx264 - Win32 Release"

# Begin Custom Build
IntDir=.\Release
InputPath=..\..\common\i386\rgb_to_yv12_mmx.asm
...
SOURCE=..\..\common\i386\sad_sse.asm

!IF  "$(CFG)" == "libx264 - Win32 Release"

# Begin Custom Build
IntDir=.\Release
InputPath=..\..\common\i386\sad_sse.asm
InputName=sad_sse
...
SOURCE=..\..\common\i386\yv12_to_rgb24_mmx.asm

!IF  "$(CFG)" == "libx264 - Win32 Release"

# Begin Custom Build
IntDir=.\Release
InputPath=..\..\common\i386\yv12_to_rgb24_mmx.asm
