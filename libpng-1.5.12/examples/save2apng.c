...
void SavePNG(char * szImage, unsigned char * p_frame, unsigned int w, unsigned int h, unsigned int d, unsigned int t, unsigned int frames)
{
  FILE * f1;
...
int main(int argc, char** argv)
{
  ...
  SavePNG("test_save2.png", &data[0][0][0][0], width, height, depth, coltype, frames);
